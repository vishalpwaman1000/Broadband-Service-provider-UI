...
export default class TechnicianHome extends Component {
  constructor(props) {
    super(props);
    this.state = {
      TechnicianID: 0,
  ...
  GetTechnicianAddress = () => {
    TechnicianDataServices.GetTechnicianAddress()
      .then((data) => {
        console.log("GetTechnicianAddress Data : ", data);
        this.setState({ Message: data.message, OpenSnackBar: true });
        if (data.isSuccess) {
          this.setState({
            TechnicianID: data.data.userID,
      ...
      .catch((error) => {
        console.log("GetTechnicianAddress Error : ", error);
  ...
  render() {
    ...
    return (
      <div className="Technician-Container">
        <div className="Technician-Container-Header">Technician Details</div>
        <div className="Technician-Container-Body">
          <div className="Technician-Container-Body-Box1">
            <div className="Technician-Container-Body-Box1-profile">
              <img
          ...
          <div className="Technician-Container-Body-Box2">
            <div>
              <TextField
                label="Technician ID"
                type="number"
        ...
        <div className="Technician-Container-Footer">
